	...
	<div class="panel panel-success">
		<div class="panel-heading">
		    <div class="btn-group pull-right">
				<button type='button' class="btn btn-success" data-toggle="modal" data-target="#nuevoTraspaso"><span class="glyphicon glyphicon-plus" ></span> Nuevo Traspaso</button>
			</div>
		...
		<div class="panel-body">
			...
			<?php
				...
				include("modal/editar_traspaso.php");
			?>
