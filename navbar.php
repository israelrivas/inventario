...
<nav class="navbar navbar-default ">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Cremerias de occidente</a>
    </div>
    ...
    <li class="<?php if (isset($active_traspasos)){echo $active_traspasos;}?>"><a href="traspasos.php"><i  class='glyphicon glyphicon-user'></i> Traspasos</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="https://wa.me/5213320573051" target='_blank'><i class='glyphicon glyphicon-envelope'></i> Soporte</a></li>
